...
VL_ATTR_COLD void VCLA_V3___024root___eval_triggers__stl(VCLA_V3___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCLA_V3___024root___eval_triggers__stl\n"); );
    // Body
...
void VCLA_V3___024root___ico_sequent__TOP__0(VCLA_V3___024root* vlSelf);

VL_ATTR_COLD void VCLA_V3___024root___eval_stl(VCLA_V3___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VCLA_V3__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCLA_V3___024root___eval_stl\n"); );
    // Body
