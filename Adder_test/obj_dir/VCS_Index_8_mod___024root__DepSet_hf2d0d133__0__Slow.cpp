...
VL_ATTR_COLD void VCS_Index_8_mod___024root___eval_triggers__stl(VCS_Index_8_mod___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCS_Index_8_mod___024root___eval_triggers__stl\n"); );
    // Body
    vlSelf->__VstlTriggered.at(0U) = (0U == vlSelf->__VstlIterCount);
    vlSelf->__VstlTriggered.at(1U) = vlSelf->CS_Index_8_mod__DOT__c8n.neq(vlSelf->__Vtrigrprev__TOP__CS_Index_8_mod__DOT__c8n);
