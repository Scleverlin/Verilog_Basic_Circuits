...
void VCS_Index_16_mod___024root___eval_triggers__ico(VCS_Index_16_mod___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCS_Index_16_mod___024root___eval_triggers__ico\n"); );
    // Body
    vlSelf->__VicoTriggered.at(0U) = (0U == vlSelf->__VicoIterCount);
    vlSelf->__VicoTriggered.at(1U) = ((IData)(vlSelf->CS_Index_16_mod__DOT__c16n) 
                                      != (IData)(vlSelf->__Vtrigrprev__TOP__CS_Index_16_mod__DOT__c16n));
...
void VCS_Index_16_mod___024root___eval_triggers__act(VCS_Index_16_mod___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VCS_Index_16_mod__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCS_Index_16_mod___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.at(0U) = ((IData)(vlSelf->CS_Index_16_mod__DOT__c16n) 
                                      != (IData)(vlSelf->__Vtrigrprev__TOP__CS_Index_16_mod__DOT__c16n));
    vlSelf->__Vtrigrprev__TOP__CS_Index_16_mod__DOT__c16n 
        = vlSelf->CS_Index_16_mod__DOT__c16n;
